...
s.camera=bpy.data.objects['R04_HERO'];s.render.engine='CYCLES';s.cycles.device='CPU';s.cycles.use_persistent_data=True if hasattr(s.cycles,'use_persistent_data') else False
# Persistent data is a RenderSettings property in this pinned Blender version.
